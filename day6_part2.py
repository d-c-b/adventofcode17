...
first_occurrence_index = seen_configs.index(seen_configs[-1])


print seen_configs[len(seen_configs)-1]
print seen_configs[first_occurrence_index]

cycle_len = (len(seen_configs) - 1) - first_occurrence_index
